...
from decorator_1 import CaseInsensitive, DictQuery, RemoveEmpty, ValueRemover
...
class TestDecoration(unittest.TestCase):
    ...
    def test_decorate(self):
        expected = {"foo": "foo", "upper": "upper", "title": "title"}
        result = CaseInsensitive(ValueRemover(RemoveEmpty(self.query))).render()
        self.assertDictEqual(result, expected)
